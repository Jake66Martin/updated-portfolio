    ...
    <>
      {!isMobile ? (
        <footer className="bg-dark footer-height d-flex justify-content-center align-items-center">
          <div className="m-5">
            <a href="https://github.com/Jake66Martin">
              <svg
                className="logo"
                id="github"
          ...
          <div className="m-5">
            <a href="https://www.linkedin.com/in/jacob-fournier-martin-5731b4279/">
              <svg
                className="logo"
                id="linkedin"
                xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="m-5">
            <a href="https://stackoverflow.com/users/22212188/dialectics">
              <svg
                className="logo"
                xmlns="http://www.w3.org/2000/svg"
                width="60"
